...
def smart_chunker(text:str, use_sementic:bool = True, fallback_chunk_size: int = 500)->list[str]:
    ...
    if use_sementic:
        try:
            ...
            print('Sementic chunking failed')
            return _recursive_fallback(text, fallback_chunk_size)
...
# Usage
chunks = smart_chunker(document, use_sementic=True)
print(f'Created {len(chunks)} sementic chunks')